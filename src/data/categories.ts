...
export const categories: Category[] = [
  ...
  },
  {
    ...
    items: [
      { name: '늑대닷컴', url: 'https://wfwf411.com/' },
      { name: '뉴토끼', url: 'https://newto17.com/' },
      { name: '마나토끼', url: 'https://mato17.com/' },
      { name: '툰코', url: 'https://tkor131.com/' },
      { name: '블랙툰', url: 'https://blacktoon415.com/' },
      { name: '나미툰', url: 'https://namee101.com/' },
      { name: '야툰', url: 'https://yatoon239.com/' },
    ],
  },
  {
