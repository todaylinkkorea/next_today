...
export const categories: Category[] = [
  {
    ...
    items: [
      ...
      { name: 'AV19', url: 'https://av19w.com/' },
      { name: '다크걸', url: 'https://darkgirl12.com/' },
      { name: '야동코리아', url: 'https://www.yako10.com/' },
      { name: '야동파티', url: 'https://ydparty02.tv/' },
      { name: '조개모아', url: 'https://www.jogemoa05.com/' },
      { name: '밤포탈', url: 'https://bampt4.com/' },
      { name: '딸플릭스', url: 'https://kr14.ddal.xyz/' },
    ],
  },
  {
    id: 'movie-panel', title: '영화/드라마', sub: '영상 콘텐츠 사이트', icon: '🎬',
    items: [
      { name: '티비위키', url: 'https://tvwiki32.net/' },
      { name: '티비룸', url: 'https://tvroom16.org/' },
      { name: '티비핫', url: 'https://tvhot2.com/' },
      { name: '콕콕티비', url: 'https://cokcok12.com/' },
      { name: '무비킹', url: 'https://mvking8.org/' },
      { name: '후후티비', url: 'https://hk.hoohootv421.xyz/' },
  ...
  },
  {
    ...
    items: [
      { name: '늑대닷컴', url: 'https://wfwf477.com/' },
      { name: '뉴토끼', url: 'https://newto16.com/' },
      { name: '마나토끼', url: 'https://mato16.com/' },
      { name: '툰코', url: 'https://tkor131.com/' },
      { name: '블랙툰', url: 'https://blacktoon414.com/' },
      { name: '나미툰', url: 'https://namee101.com/' },
      { name: '야툰', url: 'https://yatoon238.com/' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: '오피가이드', url: 'https://opga039.com/' },
      { name: '오피매니아', url: 'https://opmm04.com/' },
      { name: '오피스타', url: 'https://opmm03.com/' },
      { name: '오피아트', url: 'https://dkxm10.com/' },
      { name: '헬로밤', url: 'https://hlbam30.com/' },
      { name: '밤의민족', url: 'https://newbm35.com/' },
      { name: '키탐넷', url: 'https://kisstime4.net/' },
    ],
  },
  {
