...
export const categories: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '티비룸', url: 'https://tvroom15.org/' },
      { name: '티비핫', url: 'https://tvhot2.com/' },
      { name: '무비킹', url: 'https://mvking7.org/' },
      { name: '후후티비', url: 'https://hk.hoohootv418.xyz/' },
  ...
  },
  {
    ...
    items: [
      { name: '늑대닷컴', url: 'https://wfwf474.com/' },
      { name: '뉴토끼', url: 'https://sbxh9.com/' },
      { name: '마나토끼', url: 'https://mato14.com/' },
      { name: '툰코', url: 'https://tkor129.com/' },
      { name: '블랙툰', url: 'https://blacktoon414.com/' },
      { name: '나미툰', url: 'https://namee100.com/' },
      { name: '야툰', url: 'https://yatoon237.com/' },
    ],
  },
  {
